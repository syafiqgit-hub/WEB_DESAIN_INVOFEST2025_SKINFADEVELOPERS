        ...
        const faqData = [
            // 🔹 Edukasi finansial
            {
                keywords: ["edukasi finansial", "finansial", "belajar finansial", "keuangan pribadi", "literasi finansial"],
                response: "Edukasi finansial adalah proses belajar mengelola uang, memahami cara menabung, berinvestasi, dan menggunakan uang dengan bijak agar masa depan lebih terjamin."
            }, {
                ...
                response: "Menabung penting agar punya dana darurat, bisa capai tujuan finansial, dan menghindari utang yang tidak perlu. Tips menabung: tetapkan tujuan, sisihkan minimal 10% dari pendapatan, gunakan rekening khusus tabungan, dan hindari pengeluaran yang tidak perlu"
            }, {
            ...
            // 🔹 Info perusahaan
            {
                ...
                response: "Nama perusahaan kami adalah Cerdas Finansial dibuat oleh Cerdas Finansial dalam Partisipasi Lomba Web Design Intechfest."
            }, {
                keywords: ["layanan", "apa layanan", "produk", "jenis produk"],
                response: "Kami menyediakan layanan edukasi finansial, perencanaan keuangan, serta tips menabung dan investasi."
            }, {
                ...
                response: "Anda bisa menghubungi kami melalui WhatsApp, email, atau halaman kontak di website Cerdas Finansial."
            }, {
                ...
                response: "Tentu! Saya siap membantu menjawab pertanyaan Anda seputar edukasi finansial."
            },
            // 🔹 Keyword umum
            {
                keywords: ["halo", "hai", "hello", "permisi", "assalamualaikum", "woi", "hi", "ok"],
                response: "Halo! 👋 Ada yang bisa saya bantu terkait finansial Anda?"
            }, {
                ...
                response: `Berikut fitur-fitur Cerdas Finansial: 
1. Kalkulator Perencanaan Anggaran Pintar
2. Tabungan Tujuan Impian
3. Quiz Edukasi Finansial
4. Kalkulator Investasi Cerdas`
            }, {
                keywords: ["siapa kamu", "kamu siapa", "bot apa ini", "siapa"],
                response: "Saya adalah chatbot Cerdas Finansial 🤖 yang diciptakan oleh Skinfa Developers, siap membantu Anda dalam hal edukasi finansial."
            }
        ];
        ...
        function getResponse(userInput) {
            ...
            if (emojiOnly.test(userInput)) {
                return `${userInput} Mantap emotenya! Ada pertanyaan seputar Cerdas Finansial yang bisa saya bantu?`;
            }
            ...
            return "Maaf, saya tidak mengerti pertanyaan Anda. Silakan bertanya seputar Cerdas Finansial.";
        }
